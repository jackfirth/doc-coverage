...
(module+ test
  ...
  (check-documentation-ratio 'doc-coverage/test 0)
  ...
  (check-equal? (module-num-undocumented-exports 'doc-coverage/test) 1)
  (check-equal? (module-documentation-ratio 'doc-coverage) 1)
  (check-equal? (module-documentation-ratio 'doc-coverage/test) 0))
